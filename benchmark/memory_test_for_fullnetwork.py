...
parser.add_argument("-D","--D_list", default=[ 3, 4, 5], type=list,help="virtual_bond list")
parser.add_argument("-L","--L_list", default=[ 4, 5, 6], type=list,help="size list")
parser.add_argument("-B","--B_list", default=[ 1, 5,10], type=list,help="batch size list")
